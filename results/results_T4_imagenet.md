...
Best checkpoint: `/home/sposso22/Documents/project/sweep_T_imagenet/T4/checkpoint-442` (selected on validation accuracy).
...
| validation | 133 | 0.9323 | 0.9322 |
| test | 128 | 0.8906 | 0.8915 |
...
Distillation gap on test: Δacc = +0.0469, Δmacro-F1 = +0.0464 (teacher − student).
