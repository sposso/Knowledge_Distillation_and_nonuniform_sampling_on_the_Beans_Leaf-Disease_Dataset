...
Best checkpoint: `my-awesome-model-sampler-sgd-s3-noKD/checkpoint-396` (selected on validation accuracy = 0.9925).
...
|---|---:|---:|---:|
| train | 1034 | 0.9826 | 0.9827 |
| validation | 133 | 0.9925 | 0.9925 |
| test | 128 | 0.8984 | 0.8984 |
...
Δ test (teacher − student): acc = +0.0391, macro-F1 = +0.0395.
